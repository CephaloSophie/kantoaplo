(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.Typos = {}));
...
${options.css.trim()}` : options.css.trim()
  ...
  exports2.BUILT_IN_THEMES = BUILT_IN_THEMES;
  exports2.COLOR_PROPERTIES = COLOR_PROPERTIES;
  exports2.DEFAULT_DIRECTIVE_PREFIX = DEFAULT_DIRECTIVE_PREFIX;
  exports2.DEFAULT_TEMPLATES = DEFAULT_TEMPLATES;
  exports2.DERIVED_SHORTS = DERIVED_SHORTS;
  exports2.DIRECTIVES_BY_KEY = DIRECTIVES_BY_KEY;
  exports2.DIRECTIVES_BY_SHORT = DIRECTIVES_BY_SHORT;
  exports2.DIRECTIVE_REGISTRY = DIRECTIVE_REGISTRY;
  exports2.Emitter = Emitter;
  exports2.OVERLAY_ICONS = OVERLAY_ICONS;
  exports2.STYLE_ICONS = STYLE_ICONS;
  exports2.STYLE_PROPERTIES = STYLE_PROPERTIES;
  exports2.STYLE_VALUES = STYLE_VALUES;
  exports2.TEMPLATES_BY_KEY = TEMPLATES_BY_KEY;
  exports2.TOKENS = TOKENS;
  exports2.ThemeService = ThemeService;
  exports2.TyposCanvas = TyposCanvas;
  exports2.TyposEditor = TyposEditor;
  exports2.TyposEngine = TyposEngine;
  exports2.TyposHtmlView = TyposHtmlView;
  exports2.TyposNodeGraph = TyposNodeGraph;
  exports2.TyposPalette = TyposPalette;
  exports2.TyposSelectionOverlay = TyposSelectionOverlay;
  exports2.TyposStylePanel = TyposStylePanel;
  exports2.TyposTreeView = TyposTreeView;
  exports2.VOID_TAGS = VOID_TAGS;
  exports2.ancestorsOf = ancestorsOf;
  exports2.cloneSubtree = cloneSubtree;
  exports2.collectCustomCss = collectCustomCss;
  exports2.computeHashes = computeHashes;
  exports2.countElements = countElements;
  exports2.createComponentId = createComponentId;
  exports2.createDocument = createDocument;
  exports2.createDocumentId = createDocumentId;
  exports2.createElement = createElement;
  exports2.createElementId = createElementId;
  exports2.createId = createId;
  exports2.createTemplateId = createTemplateId;
  exports2.cyrb53 = cyrb53;
  exports2.directiveKey = directiveKey;
  exports2.documentHash = documentHash;
  exports2.elementFromDefinition = elementFromDefinition;
  exports2.elementKind = elementKind;
  exports2.elementToHtml = elementToHtml;
  exports2.emittedInProfile = emittedInProfile;
  exports2.escapeAttr = escapeAttr;
  exports2.findById = findById;
  ...
  exports2.isTyposDirectiveKey = isTyposDirectiveKey;
  exports2.mountTyposEditor = mountTyposEditor;
  exports2.moveTo = moveTo;
  exports2.parseDocument = parseDocument;
  exports2.parseDocumentValue = parseDocumentValue;
  exports2.parseHtmlToTree = parseHtmlToTree;
  exports2.recomputeDerivedDirectives = recomputeDerivedDirectives;
  exports2.removeById = removeById;
  exports2.reorder = reorder;
  exports2.replaceById = replaceById;
  exports2.serializeDocument = serializeDocument;
  exports2.specForKey = specForKey;
  exports2.stripDerived = stripDerived;
  exports2.toKebab = toKebab;
  exports2.treeToHtml = treeToHtml;
  exports2.unwrapElement = unwrapElement;
  exports2.updateElement = updateElement;
  exports2.validateDocument = validateDocument;
  exports2.validateElement = validateElement;
  exports2.walk = walk;
  exports2.withDirective = withDirective;
  exports2.wrapElement = wrapElement;
  Object.defineProperty(exports2, Symbol.toStringTag, { value: "Module" });
});
//# sourceMappingURL=typos.umd.cjs.map
